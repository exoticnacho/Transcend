...
function DueScheduleCard({
    ...
    return (
        <div className="bg-red-900/10 border border-red-500/30 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
                <FaExclamationCircle className="text-red-500 text-2xl shrink-0" />
                <div>
                    <h4 className="font-bold text-white break-all">{schedule.name}</h4>
